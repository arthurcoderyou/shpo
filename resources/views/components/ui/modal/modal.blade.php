@props([
    ...
    'btnClass' => 'inline-flex   items-center gap-2 rounded-lg bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow hover:bg-sky-700 focus-visible:outline focus-visible:ring',
    'submitBtnClass' => "px-3.5 py-2 rounded-lg text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60"
])
@php
...
<div x-data="{ open:false }" class="relative  items-center align-middle w-full">
        ...
        <div x-data="{ openModal:false }" class="shrink-0">
            ...
            <div x-show="openModal"
                ...
                <div @click.away="openModal = false"
                    class="w-full max-w-lg rounded-xl bg-white shadow-xl ring-1 ring-black/5">
                    ...
                    <div class="px-5 py-4 flex items-center justify-end gap-2 border-t border-slate-200">
                        ...
                        <button type="button"
                                ...
                                {{ $attributes->merge(['class' => $submitBtnClass]) }} 
                                wire:loading.attr="disabled"
                                wire:target="{{ $wireAction }}">
                            {{ $submitBtnLabel }}
                        </button>
