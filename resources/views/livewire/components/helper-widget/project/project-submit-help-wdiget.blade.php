        ...
        >
            <div class="bg-white w-full max-w-lg rounded-xl shadow-lg p-6 space-y-4">
                ...
                <p class="text-sm text-slate-600 leading-relaxed">
                    Your project has been created — great job! 🎉  
                    Before you can upload any project documents, the project needs to be
                    <strong>submitted for SHPO review</strong>.
                </p>

                <p class="text-sm text-slate-600 leading-relaxed">
                    Submitting your project allows the SHPO team to officially receive it,
                    start the evaluation, and enable document uploads for the review process.
                </p>
                ...
                <div class="border-l-4 border-blue-400 bg-blue-50 p-3 rounded">
                    ...
                    <ol class="list-decimal list-inside text-sm text-slate-700 space-y-1 mt-2">
                        ...
                        <li>Click the <strong>“Submit Project”</strong> button below. You can also click on the <strong>"Submit Project"</strong> button above on the page header</li>
                        <li>Once submitted and reviewed by SHPO, document uploads will be unlocked.</li>
                    </ol>
                </div>

                <p class="text-xs text-slate-500 mt-2">
                    Don’t worry — you can still update your project information later if needed.
                </p>
                ...
                <div class="flex justify-between gap-3 mt-6">
                    ...
                    <div class="flex justify-end gap-3 mt-4">
                        ...
                        <button
                            ...
                            @click="
                                open = false;
                                $wire.submit_project({{ $project_id }});
                            "
                        >
                            Submit Project
                        </button>
