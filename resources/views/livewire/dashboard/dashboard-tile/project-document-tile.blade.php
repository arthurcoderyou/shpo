...
<div class="flex flex-col justify-between bg-white border border-gray-200 shadow-lg rounded-2xl hover:shadow-xl transition-shadow duration-300">
    
    <!-- Content Section -->
    <div class="p-5 flex justify-between items-start gap-x-4">
