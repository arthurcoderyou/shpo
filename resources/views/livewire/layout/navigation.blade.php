            ...
            <div class="py-2 md:py-0  flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
                <div class="grow">
                    <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                        ...
                        <div class="bg-gray-50 border border-gray-200 text-sm text-gray-600 rounded-lg p-2 dark:bg-white/10 dark:border-white/10 dark:text-neutral-400" role="alert" tabindex="-1" aria-labelledby="hs-link-on-right-label">
                            <div class="flex">
                            <div class="shrink-0">
                            ...
                            <div class="flex-1 md:flex md:justify-between ms-2">
                                ...
                                <p class="text-sm  ms-6">
                                    <button wire:click="markDeviceAsTrusted('yes')" class="text-green-800 hover:text-gray-500 focus:outline-hidden focus:text-gray-500 font-medium whitespace-nowrap dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400" href="#">
                                        Yes
                                    </button>
                                    <button wire:click="markDeviceAsTrusted('no')" class="text-red-800 hover:text-gray-500 focus:outline-hidden focus:text-gray-500 font-medium whitespace-nowrap dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400" href="#">
                                        No
                                    </button>
                                </p>
                            </div>
