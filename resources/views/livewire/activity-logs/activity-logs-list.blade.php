                    ...
                    @if(!empty($activity_logs) && count($activity_logs) > 0)
                        @foreach ($activity_logs as $activity_log)
                            <tr>
                                ...
                                <td class="size-auto whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        <div class="flex items-center gap-x-3">
                                            <div class="grow">
                                                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $activity_log->user->name }}</span>
                                                <span class="block text-sm text-gray-500 dark:text-neutral-500">{{ $activity_log->user->email }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="size-auto whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        <span class="block text-sm text-gray-500 dark:text-neutral-500">{{ $activity_log->log_action }}</span>
                                    </div>
                                </td>

                                <td class="size-auto whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        <span class="text-sm text-gray-500 dark:text-neutral-500">{{ \Carbon\Carbon::parse($activity_log->created_at)->format('M d Y, h:i A') }}</span>
                                    </div>
                                </td>
