                            ...
                            <tr>
                                ...
                                <td class="h-px w-52 min-w-52 align-top">
                                    <a class="block p-6" href="#">
                                      ...
                                      <span class="block text-sm font-semibold text-gray-800 ">{{ $forum->project->name }}</span> 
                                    </a>
                                </td>
                                ...
                                <td class="h-px size-auto align-top">
                                    <a class="block p-6" href="#">
                                      ...
                                      <span class="block text-sm font-semibold text-gray-800 ">{{ $forum->title }}</span>
                                      <span class="block text-sm text-gray-500 ">{{ $forum->description }}</span>
                                    </a>
                                </td>
                                ...
                                <td class="w-4 whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        ...
                                        <!-- forum discussions -->
                                        <a title="View discussions" href="{{ route('discussion.index',['forum' => $forum->id]) }}" 
                                            wire:navigate
