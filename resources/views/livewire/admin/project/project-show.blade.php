        ...
        <div class="bg-white rounded-xl shadow dark:bg-neutral-900">
            <div class="p-4">
                ...
                <div class="flex items-center ">
                    ...
                    <div class="grow">
                        <h1 class="text-xl mb-0 font-medium text-sky-800 dark:text-neutral-200">
                            Project Details  
                            

                        </h1>
                        @if(Auth::user()->hasRole('Reviewer'))
                            <a class="text-sm mt-0" href="{{ route('project.review',['project' => $project->id ]) }}">Click to Review</a>
                        @endif
                        ...
                        <p class="text-sm text-blue-600  dark:text-neutral-400">
                            {{ $type }} 
                        </p>

                        @if(!Auth::user()->hasRole('User'))
                            <p class="text-sm text-green-600 dark:text-neutral-400">
                                Project #: {{ !empty($project_number) ? $project_number : 'NOT SET' }}
                            </p>
                            <p class="text-sm text-yellow-600 dark:text-neutral-400">
                    ...
                    <div>
                        <p class="text-sm text-gray-600 dark:text-neutral-400">
                            <strong>Project Status:</strong> {!! $status !!}
                        </p>
                        @if($project->status !== "approved")
                            @if(!empty($project_reviewer))
                                
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    <strong>Review Status:</strong>  {!! $project_reviewer->getReviewStatus() !!}
                                </p>
                                <p class="text-sm text-gray-600 dark:text-neutral-400">
                                    <strong>Currently Reviewed by:</strong> <br>{{ $project_reviewer->user->name }}
                                </p>
                            @endif
                            ...
                            <p class="text-sm text-gray-600 dark:text-neutral-400 ">
                                Expected project update and submission  on or before <br>  
                                <strong>
                ...
                <div class="mt-4">
                    ...
                    <ul class="mt-5 flex flex-col gap-y-3">
                        ...
                        <li class="flex items-center gap-x-2.5">
                            ...
                            <p class="text-[13px] text-gray-500   hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400" href="#">
                    ...
                    <div class="text-end">
                        ...
                        @else
                            <p class="text-sm text-lime-600  dark:text-neutral-400">
                               Project is approved
                            </p>
                        @endif
