...
<div class="max-w-full px-4 py-6 sm:px-6 lg:px-8  mx-auto">
        ...
        <div class="p-1.5 min-w-full inline-block align-middle">
                ...
                <div class="inline-flex gap-x-2 text-nowrap">
                    ...
                    <div class="inline-flex items-center gap-x-2  max-w-52"> 
                        <x-ui.select 
                            id="role_request"
                            name="role_request" 
                            wire:model.live="role_request"     
                            :options="$role_request_options"
                        />
                    ...
                    @can(['system access global admin'])
                        {{-- <div class="inline-flex items-center gap-x-2">
                            ...
                            <select wire:model.live="user_status_filter" class="py-2 px-3 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500   ">
                        ...
                        <div class="inline-flex items-center gap-x-2  max-w-52"> 
                            <x-ui.select 
                                ...
                                wire:model.live="user_status_filter"     
                    ...
                    {{-- @if(Auth::user()->can('system access global admin')  || Auth::user()->can('user delete'))
                        <button
            ...
            <table class="min-w-full divide-y divide-gray-200 ">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-2 py-3 text-start"></th>
                                    ...
                                    @php
                                        $options = [
                                            ...
                                            [
                                                'type'  => 'link',
                                                'label' => 'Edit Role',
                                                'href'  =>  route('user.edit_role', ['user' => $user->id]),
                                                'icon'  => 'role_edit', // you can tweak
                                                'attrs' => [
                                                    'wire:navigate' => true,
                                                ],
                                            ],
                                            ...
                                            [   
                                                ...
                                                'confirm_btn_action' => 'delete('.$user->id.')',
                                                // 'attrs' => [
                                        ...
                                        <div class="flex items-start gap-x-3">
                                            <div class="grow">
                                                <ul class="space-y-1 text-sm text-gray-500">
                                                    ...
                                                    @empty
                                                        <li class="text-gray-400">No roles assigned</li>
                                                    @endforelse
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                {{-- <td class="w-4 whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        ...
                                        @if(empty($user->deleted_at))
                                            @if(Auth::user()->can('system access global admin')  || Auth::user()->can('user edit'))
                                            <!-- edit -->
                                            <a href="{{ route('user.edit_role',parameters: ['user' => $user->id]) }}" 
                                                wire:navigate
                                                ...
                                                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-700" viewBox="0 0 640 512" fill="currentColor" aria-hidden="true">
                                                    <path d="M630.6 364.9l-90.3-90.2c-12-12-28.3-18.7-45.3-18.7h-79.3c-17.7 0-32 14.3-32 32v79.2c0 17 6.7 33.2 18.7 45.2l90.3 90.2c12.5 12.5 32.8 12.5 45.3 0l92.5-92.5c12.6-12.5 12.6-32.7.1-45.2zM447.8 343.9c-13.3 0-24-10.7-24-24s10.7-24 24-24 24 10.7 24 24c0 13.2-10.7 24-24 24zM224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm127.8 111.2V294c-12.2-3.6-24.9-6.2-38.2-6.2h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 287.9 0 348.1 0 422.3v41.6c0 26.5 21.5 48 48 48h352c15.5 0 29.1-7.5 37.9-18.9l-58-58c-18.1-18.1-28.1-42.2-28.1-67.8z"/>
                                                </svg>
                                        ...
                                        @else
                                            ...
                                            @if(Auth::user()->can('system access global admin'))
                                                ...
                                                <button
                                                 ...
                                                 wire:click="confirmRecover({{ $user->id }})"
                                                type="button" class="py-2 px-3 inline-flex items-center gap-x-2  text-sm font-medium rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 focus:outline-none focus:bg-green-700 disabled:opacity-50 disabled:pointer-events-none">
                                                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#ffffff" d="M184.6 261.9c3.2 14-12.1 24.6-24.1 17.2l-40.7-25.5-50.9 81.4C55.6 356.3 71 384 96 384H148c6.6 0 12 5.4 12 12v40c0 6.6-5.4 12-12 12H96.1c-75.3 0-121.3-83-81.4-146.9l50.8-81.4-40.7-25.4c-12.1-7.5-9-26 4.9-29.2l110.2-25.5c8.6-2 17.2 3.4 19.2 12l25.5 110.2zm98.6-182.9l41.3 66.1-40.7 25.5c-12.1 7.5-9 26 4.9 29.2l110.2 25.5c8.7 2 17.2-3.4 19.2-12l25.5-110.2c3.2-13.8-12-24.7-24.1-17.2l-40.7 25.4-41.3-66.1c-37.5-60-125.2-60.2-162.8 0l-18 28.8c-3.5 5.6-1.8 13 3.8 16.5l33.9 21.2c5.6 3.5 13 1.8 16.5-3.8l18-28.7c12.7-20.3 42-19.7 54.3 0zM497.3 301.1l-27.5-44.1c-3.5-5.6-10.9-7.3-16.5-3.8l-33.9 21.2c-5.6 3.5-7.3 10.9-3.8 16.5l27.6 44.1c13.3 21.2-2.1 49-27.1 49H320V336c0-14.2-17.2-21.4-27.3-11.3l-80 80c-6.2 6.2-6.2 16.4 0 22.6l80 80C302.7 517.3 320 510.3 320 496V448h95.9c75.3 0 121.3-83 81.4-146.9z"/></svg>
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    type="button"
                                                    class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gray-600 text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700"
                                                >
                                                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="#ffffff" d="M432 32H312l-9.4-18.7A24 24 0 0 0 281.1 0H166.8a23.7 23.7 0 0 0 -21.4 13.3L136 32H16A16 16 0 0 0 0 48v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16V48a16 16 0 0 0 -16-16zM53.2 467a48 48 0 0 0 47.9 45h245.8a48 48 0 0 0 47.9-45L416 128H32z"/></svg>
                                                </button>
    ...
    <!-- End Card -->
     ...
     @if($confirmingForceDelete)
        <form wire:submit.prevent="executeForceDelete" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md">
                <h2 class="text-lg font-semibold text-red-600">Confirm Permanent Deletion</h2>
                ...
                <div class="mt-6 flex justify-end space-x-2">
                    <button wire:click="$set('confirmingForceDelete', false)"
                            type="button"
    ...
    @if($confirmingRecover)
        <form wire:submit.prevent="executeRecover" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md">
                <h2 class="text-lg font-semibold text-green-600">Confirm Account Recovery</h2>
                <p class="text-sm text-gray-700 mt-2">
                    This action <strong>cannot be undone</strong>. Please enter your password to confirm.
                </p>
                ...
                <div class="mt-6 flex justify-end space-x-2">
                    <button wire:click="$set('confirmingRecover', false)"
                            type="button"
                            class="px-4 py-2 text-sm rounded-md border border-gray-300 text-gray-700 bg-white hover:bg-gray-50">
                        Cancel
                    </button>
    ...
    @endif
      ...
      {{-- @if($showPasswordRehashed)
        <form wire:submit.prevent="executeRecover" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-md">
                <h2 class="text-lg font-semibold text-green-600">Show Password</h2>
                <p class="text-sm text-gray-700 mt-2">
                    This action <strong>is confidential</strong>. Please enter your password to confirm.
                </p>
