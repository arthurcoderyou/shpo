                                ...
                                <td class="w-4 whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        ...
                                        @if(empty($user->deleted_at))
                                            ...
                                            <!-- edit -->
                                            <a href="{{ route('user.edit_role',parameters: ['user' => $user->id]) }}" class="py-2 px-3 inline-flex items-center gap-x-2  text-sm font-medium rounded-lg border border-transparent bg-sky-600 text-white hover:bg-sky-700 focus:outline-none focus:bg-sky-700 disabled:opacity-50 disabled:pointer-events-none">
