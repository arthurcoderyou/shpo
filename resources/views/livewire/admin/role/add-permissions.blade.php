            ...
            <div class="px-3 py-2 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                ...
                <div>
                    <div class="sm:col-span-2 flex gap-x-2 items-center justify-center">
                        ...
                        <label for="select_all" class="flex py-2 px-3 w-32 bg-white border border-sky-500 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                            ...
                            <tr>
                                ...
                                <td class="size-auto whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        ...
                                        <div class="grow">
                                            <span class="block text-sm text-gray-500 dark:text-neutral-500">{{ $module }}</span>
                                        </div>
                                        </div>
                                    </div>
                                </td>
