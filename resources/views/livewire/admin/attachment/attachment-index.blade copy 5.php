  ...
  <div class="flex" >
      ...
      <aside id="desktop-sidebar" data-collapsed="true"  class="hidden lg:flex lg:flex-col data-[collapsed=true]:w-20 transition-[width] lg:w-72 lg:min-h-screen lg:sticky lg:top-0 lg:border-r bg-white">
        ...
        <div class="px-5 py-4 border-b flex items-center justify-between">
          ...
          <button onclick="toggleSidebarCollapsed()" class="inline-flex items-center justify-center rounded-lg border px-2 py-2 hover:bg-gray-50" aria-label="Toggle sidebar">
            <!-- show when expanded -->
            <svg id="icon-collapse" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            <!-- show when collapsed -->
            <svg id="icon-expand" class="w-4 h-4 hidden" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
          </button>

        </div>
          <!-- Sidebar nav -->
        <nav class="flex-1 overflow-y-auto px-3 py-4">
          <p class="label group-data-[collapsed=true]:hidden px-3 text-xs font-semibold text-slate-400 "  >
              MAIN
          </p>
            ...
            <li  >
               <details class="group">
                <summary class="flex items-center justify-between px-3 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 hover:text-indigo-700"
                  ...
                  <svg class="label group-data-[collapsed=true]:hidden w-4 h-4 text-slate-400 group-open:rotate-180 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </summary>
          ...
          <p class="label group-data-[collapsed=true]:hidden mt-6 px-3 text-xs font-semibold text-slate-400">
            DOCUMENT 
          </p>
          <ul class="mt-2 space-y-1">
            <li>
              <details class="group">
                <summary class="flex items-center justify-between px-3 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 hover:text-indigo-700">
                  <span class="flex items-center gap-2">
                    ...
                    <span class="label group-data-[collapsed=true]:hidden">Documents</span>
                  </span>
                  <svg class="label group-data-[collapsed=true]:hidden w-4 h-4 text-slate-400 group-open:rotate-180 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
                </summary>
                <ul class="ml-6 mt-1 space-y-1 text-sm">
      ...
      <aside id="mobile-drawer" class="lg:hidden fixed inset-y-0 left-0 w-72 bg-white border-r z-50 translate-x-[-100%] transition-transform duration-200 ease-out">
        <div class="px-5 py-4 border-b flex items-center justify-between">
            <div class="flex items-center gap-3">
              <span class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-indigo-600 text-white font-bold">A</span>
              <div>
                  <div class="font-semibold">Your App Mobile</div>
                  <div class="text-xs text-slate-500">Admin Portal Mobile</div>
              </div>
            </div>
        ...
        <nav class="px-3 py-4 h-[calc(100vh-64px)] overflow-y-auto flex-1">
          ...
          <p class="px-3 text-xs font-semibold text-slate-400">MAIN Mobile</p>
          <ul class="mt-2 space-y-1">
            <li>
              <details class="group">
                <summary class="flex items-center justify-between px-3 py-2.5 rounded-xl cursor-pointer hover:bg-indigo-50 hover:text-indigo-700">
