            ...
            <div class="p-1.5 max-w-full ">
                ...
                <div class=" px-3 py-2 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 text-nowrap">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800  inline-flex items-center gap-x-2">
                            Permissions <span class="shrink-0 flex justify-center items-center size-[30px] text-sm bg-black text-white rounded-full  ">{{ $permission_count ?? 0 }}</span>
                        </h2>
                    ...
                    <div>
                    <div class="grid space-y-1 sm:space-y-0 sm:inline-flex gap-x-2">
                        ...
                        <x-ui.button 
                            ...
                            sr="Create new permission" 
                            :linkHref="route('permission.create')" {{-- to make it as a link --}}
                            ...
                            displayTooltip
                            tooltipText="Create new permission"
                            position="left"
                        >
                            ...
                            @foreach ($permissions as $permission)
                                <tr>
                                    {{-- <td class="w-4 whitespace-nowrap">
                                        <div class="px-2 py-2">
                                            <label for="user_{{ $permission->id }}" class="flex">
                                                <input type="checkbox"
                                        ...
                                        @php
                                            $options = [
                                                ...
                                                [
                                                    ...
                                                    'confirm_btn_action' => 'delete('.$permission->id.')', 
                                                    // 'attrs' => [
                                    ...
                                    <td class="size-auto whitespace-nowrap">
                                        <div class="px-2 py-2">
                                            ...
                                            <div class="grow">
                                                <span class="block text-sm text-gray-500 ">{{ $permission->name }}</span>
                                            </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="size-auto whitespace-nowrap">
                                        <div class="px-2 py-2">
                                            <div class="flex items-center gap-x-3">
                                            <div class="grow">
                                                <span class="block text-sm text-gray-500 ">{{ $permission->module }}</span>
                                            </div>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="px-2 py-2">
                                            ...
                                            <div class="grow">
                                                <span class="block text-sm text-gray-500 ">
                                                    {{ \Carbon\Carbon::parse($permission->updated_at)->format('d M, H:i') }}
                                                </span>
                                            </div>
                                            </div>
                                        </div>
                                    ...
                                    {{-- <td class="w-4 whitespace-nowrap">
                                        <div class="px-2 py-2">
                                            ...
                                            wire:click.prevent="delete({{ $permission->id }})"
                ...
                <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 ">
                    ...
                    <div class="inline-flex items-center gap-x-2">
                        ...
                        <p class="text-sm text-gray-600 ">
                            {{ count($permissions) > 0 ? 'of '.$permissions->total()  : '' }}
                        </p>
                    </div>
