            ...
            <div class="  p-4">
                ...
                <div class="grid grid-cols-12 gap-x-2  ">
                    ...
                    <div class="space-y-2 col-span-12 sm:col-span-6  ">
                        ...
                        <select autofocus autocomplete="module"
                        wire:model="module" 
                        id="module"
                        name="module"
                ...
                <div class="mt-5 flex justify-center gap-x-2">
                    <a href="{{ route('permission.index') }}" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                        Cancel
                    </a>
