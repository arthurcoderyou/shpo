<!-- Card Section -->
<div id="review_create" class="max-w-[85rem] px-4 py-6 sm:px-6 lg:px-8  mx-auto">
    ...
    {{-- <div wire:loading class="loading-overlay">
        ...
        <div class="bg-white rounded-xl shadow ">
            ...
            <div class="  p-4">
                ...
                @if(!empty($project->shpo_number))<!-- review -->
                    @if($project->allow_project_submission == false && $project->status !== "approved") <!-- if the submission for user is not allowed, it means a feedback is needed by the reviewer and this is opened --> 
                        ...
                        @if($project->getCurrentReviewer()->user_id == Auth::user()->id)
                            ...
                            <div class="mt-5 flex justify-center gap-x-2">
                                ...
                                <a href="{{ route('project.index.review-pending.all-linked') }}" 
                                wire:navigate
                ...
                @elseif($project->getCurrentReviewer()->user_id == Auth::user()->id)<!-- project shpo number update and project references-->
                    ...
                    <div class="mt-5 flex justify-center gap-x-2">
                        <a href="{{ route('project.index.review-pending.all-linked') }}" wire:navigate class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gray-600 text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 disabled:opacity-50 disabled:pointer-events-none">
                            Cancel
                        </a>
