...
<div id="review_create" class=" px-4 py-6 sm:px-6 lg:px-8  mx-auto">
    ...
    {{-- <div wire:loading class="loading-overlay">
        ...
        <div class="grid grid-cols-12 gap-3">
                    ...
                    <div class="  p-4">
                                        ...
                                        @foreach($project_documents as $project_reference)
                                            ...
                                            >
                                                <p class="font-semibold text-gray-800">
                                                    {{ $project_reference->document_name }}
                                                </p>
                                                <div class="text-gray-600">
                                                    <p><span class="font-medium">Project :</span> {{ $project_reference->project_name }}</p>
                        ...
                        <div class="space-y-2 col-span-12   ">
                            <div class="mt-5 flex justify-center gap-x-2">
                                ...
                                @if($project_reviewer->order !== 1)
                                    <button type="button"
                                    onclick="confirm('Are you sure, you want to save this project information details? This will also approve the initial review of the project') || event.stopImmediatePropagation()"
            ...
            <!-- Review Card -->
            <div class="col-span-12 @if(!Auth::user()->hasPermissionTo('system access reviewer')
                || 
                (Auth::user()->hasPermissionTo('system access reviewer') && Auth::user()->hasPermissionTo('system access admin'))
                ) sm:col-span-4 @endif ">  
                <div class="rounded-2xl border border-slate-200 ">
                                ...
                                @if($project_document->status !== "approved") 
                                    ...
                                    $project_reviewer->review_status == "pending")
                                        <div class="grid grid-cols-12 space-y-3  mt-2.5">
                                            ...
                                            <!-- Notes -->
                                            <div class="col-span-12">
                                            <label for="project_review" class="mb-1 block text-sm font-medium text-slate-700">Notes to submitter (required for “Changes Requested” or “Reject”)</label>

                                            <textarea id="project_review" name="project_review" wire:model="project_review" rows="5"
