            ...
            <div class="px-3 py-2 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                ...
                <div class="inline-flex gap-x-2">
                    ...
                    <input type="text" wire:model.live="search"
                        class="py-2 px-3 inline-flex max-w-32 items-center gap-x-2 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                        placeholder="Search">
                    ...
                    <button
                        ...
                        class="py-2 px-3 inline-flex min-w-12 items-center gap-x-2 border-2 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50   dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                    ...
                    <div class="inline-flex items-center gap-x-2">
                        ...
                        <select wire:model.live="view_status" class="py-2 px-3 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                    ...
                    <div class="inline-flex items-center gap-x-2">
                        ...
                        <select wire:model.live="review_status" class="py-2 px-3 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                                    ...
                                    <div class="px-2 py-2">
                                        ...
                                        @if($review->admin_review == true)
                                            ...
                                            <div class="flex items-center gap-x-3">
                                                ...
                                                <div class="grow">
                                                    <h1 class="text-lg font-medium text-black dark:text-neutral-200">
                                                ...
                                                <div class="grow">
                                                    ...
                                                    <ul class="mt-2 flex flex-col gap-y-3">
                                                        <li class="flex items-center gap-x-2.5">
                                                            ...
                                                            <a class="text-[13px] text-gray-500 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2 dark:text-neutral-500 dark:hover:text-neutral-400" href="mailto:{{ $review->reviewer->email }}">
                                        ...
                                        @else 
                                            ...
                                            <div class="flex items-center gap-x-3">
                                                ...
                                                <div class="grow">
                                                    <h1 class="text-lg font-medium text-blue-800 dark:text-neutral-200">
