                        ...
                        @foreach ($settings as $setting)
                            <tr>
                                <td class="w-4 whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        <label for="user_{{ $setting->id }}" class="flex">
                                            <input type="checkbox"
                                ...
                                <td class="size-auto whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        <div class="flex items-center gap-x-3">
                                        <div class="grow">
                                            <span class="block text-sm text-gray-500 ">{{ $setting->key }}</span>
                                        </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="w-4 whitespace-nowrap">
                                    <div class="px-2 py-2">
                                        <!-- edit -->
                                        <a href="{{ route('setting.edit',['setting' => $setting->id]) }}" class="py-2 px-3 inline-flex items-center gap-x-2  text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                                        ...
                                        wire:click.prevent="delete({{ $setting->id }})"
