        ...
        <div class="bg-white rounded-xl shadow ">
            ...
            <div class="  p-4">
                ...
                <div class="grid grid-cols-12 gap-x-2  ">
                    ...
                    <div class="space-y-2 col-span-12 sm:col-span-6 ">
                        <label for="key" class="inline-block text-sm font-medium text-gray-800 mt-2.5 ">
                            Key
                        </label>

                        <input
                        autofocus autocomplete="key"
                        wire:model="key"
                        id="key" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none " placeholder="">
                    ...
                    <div class="space-y-2 col-span-12 ">
                        ...
                        <textarea autofocus autocomplete="description"
                ...
                <div class="mt-5 flex justify-center gap-x-2">
                    <a href="{{ route('setting.index') }}" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                        Cancel
                    </a>
