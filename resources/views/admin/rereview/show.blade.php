<x-app-layout>
    ...
    @php
        $items = [
            ...
            ['label' => $project_document->document_type->name, 'url' => route('project.project-document.show', ['project' => $project_document->project->id, 'project_document' => $project_document->id]) ],
