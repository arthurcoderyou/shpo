                ...
                <div class="px-3 py-2    border-b border-gray-200 ">
                    ...
                    <main id="content">
                        ...
                        <p class="mt-3 text-gray-600 ">
                            ⏱️ We're currently undergoing maintenance or experiencing technical difficulties.
                        </p>
                    ...
                    <footer class="mt-auto text-center py-5">
                        ...
                        <p class="text-sm text-gray-500 "> &copy; Copyright {{ date('Y') }} | All Rights Reserved | Dimension Systems, Inc.  </p>
                        </div>
                    </footer>
                    <!-- ========== END FOOTER ========== -->
