        ...
        <div class="p-1.5 min-w-fit mx-auto block align-middle">
            ...
            <div class="px-3 py-2    border-b border-gray-200 ">
                ...
                <main id="content">
                    ...
                    <h1 class="block text-7xl font-bold text-gray-800 sm:text-9xl ">404 - Page Not Found</h1>
                    <p class="mt-3 text-gray-600 ">🚧 Oops! The page you're looking for doesn't exist.</p>
                    <p class="text-gray-600 ">🔗 Please check the URL or return to the homepage.</p>
                    <div class="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
                        <a href="{{ route('dashboard') }}" class="w-fit sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="../examples.html">
