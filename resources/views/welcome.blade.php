    ...
    <body class="font-sans antialiased bg-white">
        <div class="min-h-screen pt-10 sm:pt-32 ">
            ...
            <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">SHPO <span class="text-blue-600"> Project Portal</span></h1>
