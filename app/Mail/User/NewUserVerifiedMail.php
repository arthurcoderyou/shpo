...
class NewUserVerifiedMail extends Mailable
{
    ...
    {
        $subject = UserLogHelper::getActivityMessage('your-account-verified',$this->user->id, $this->user->id);
    ...
    public function content(): Content
    {
        ...
        return new Content(
            markdown: 'emails.user.new_user_verified',       
            text: 'emails.user.new_user_verified_plain',      
            with: [
                'user' => $this->user,
