...
class FollowupReviewRequestMail extends Mailable implements ShouldQueue
{
    ...
    public function content(): Content
    {
        ...
        return new Content(
            markdown: 'emails.project-document.review.followup_review_request',
            text: 'emails.project-document.review.followup_review_request_plane',
            with: [
    ...
    protected function submittedAtDisplay(): array
    {
        ...
        $base = $this->document->last_submitted_at
