...
class ReviewFlow extends Component
{
    ...
    public function mount( $project_document_id)
    {
        ...
        if (!empty($this->project_document->document_type_id)) {
            ...
            if(!empty($current_reviewer)){
                ...
                $this->currentReviewerId = $current_reviewer->id;
            }
    ...
    public function open_review_project_document($project_document_id){
        ...
        if(!empty($current_reviewer)){
            ...
            // If there is no previous URL, redirect to the dashboard
            return route('project_document.review.flow', [ 
        ...
        Alert::success('Success', 'Open Review Claimed Successfully');
        return route('project_document.review.flow', [ 
            'project_document' => $this->project_document->id,
        ]);
    ...
    {
        return view('livewire.admin.project-document-reviewer.review-flow');
    }
}
