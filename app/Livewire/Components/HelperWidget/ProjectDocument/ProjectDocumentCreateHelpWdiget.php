...
namespace App\Livewire\Components\HelperWidget\ProjectDocument;
...
class ProjectDocumentCreateHelpWdiget extends Component
{
...
public bool $showGuide = false;
    ...
    public function mount(int $project_id){
        ...
        if ($user) {
            ...
            $user_help_widget = HelpWdigetSettings::where('user_id', $user->id)
                ->where('widget','livewire.components.helper-widget.project-document.project-document-create-help-wdiget')
                ->first();
    ...
    public function updateDsaStatus(){
       ...
       HelpWdigetSettings::updateOrCreate([
            ...
            'widget' => 'livewire.components.helper-widget.project-document.project-document-create-help-wdiget'
       ],   
    ...
    {
        return view('livewire.components.helper-widget.project-document.project-document-create-help-wdiget');
    }
}
