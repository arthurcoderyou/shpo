...
class ProjectSubmitHelpWdiget extends Component
{
    ...
    public function mount(int $project_id){
        ...
        if ($user) {
            ...
            $user_help_widget = HelpWdigetSettings::where('user_id', $user->id)
                ->where('widget','livewire.components.helper-widget.project.project-submit-help-wdiget')
                ->first();
    ...
    public function updateDsaStatus(){
       ...
       HelpWdigetSettings::updateOrCreate([
            ...
            'widget' => 'livewire.components.helper-widget.project.project-submit-help-wdiget'
       ],   
    ...
    {
        return view('livewire.components.helper-widget.project.project-submit-help-wdiget');
    }
}
