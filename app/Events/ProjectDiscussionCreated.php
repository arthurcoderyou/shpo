...
class ProjectDiscussionCreated implements ShouldBroadcast, ShouldQueue
{
    ...
    public function __construct($project,$project_discussion)
    {
        ...
        $this->message = "New discussion added on project '{$this->project->name}'";
        ...
        if(!empty($this->project_discussion->project_document_id)){
            ...
            $this->message = "New discussion added on document '{$this->project_discussion->project_document->document_type->name}' for project '{$this->project->name}'";
