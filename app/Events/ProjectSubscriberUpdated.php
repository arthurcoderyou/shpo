...
class ProjectSubscriberUpdated implements ShouldBroadcast, ShouldQueue
{
    ...
    public function __construct(ProjectSubscriber $project_subscriber, $authId)
    {
        ...
        $this->message = "Project subscriber '".$this->project_subscriber->user->name."' updated for project '".$this->project_subscriber->project->name."'";
    }
