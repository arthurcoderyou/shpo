...
class ProjectReviewFollowupNotification extends Notification  implements ShouldQueue
// implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $email = (new MailMessage)
            ->subject("Project Update Review Request: {$this->project->name}")
            ->markdown('emails.project.review_followup', [
