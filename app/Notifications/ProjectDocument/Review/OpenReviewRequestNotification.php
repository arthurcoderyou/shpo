...
class OpenReviewRequestNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => "Open Review Request on '".$this->project_document->document_type->name."' on '".$this->project->name."' ",
            'url' => route('project-document.index.open-review'),
        ];
    }
}
